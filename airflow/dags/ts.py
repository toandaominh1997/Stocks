...
with DAG(
    ...
    nb_task = PapermillOperator(
        task_id="training_TS",
        input_nb="/opt/code/modeling/TS.ipynb",
        output_nb="/opt/code/modeling/output/TS-{{ execution_date }}.ipynb",
        parameters={"msgs": "Ran from Airflow at {{ execution_date }}!"}
    )
    nb_test_task = PapermillOperator(
        task_id="testing",
        input_nb="/opt/code/modeling/TEST.ipynb",
        output_nb="/opt/code/modeling/output/test-{{ execution_date }}.ipynb",
        parameters={"msgs": "Ran from Airflow at {{ execution_date }}!"}
    )
